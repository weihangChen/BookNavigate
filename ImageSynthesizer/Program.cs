...
namespace ImageSynthesizer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //character identity, we are going to normalize them as the first step, then for each image, either we synthesize it or
            //or we make some copies of it (if we are using windows font for testing, 14 fonts, 1000 copies are enougth)
